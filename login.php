      ...
      <nav class="grey darken-4" role="navigation" style:"height:26px;">
         <div class="nav-wrapper container" style="height:26px;">
            <ul class="right hide-on-med-and-down">
               ...
               <li><a href="student.html" style="color:white">Student Portal</a></li>
            </ul>
  ...
  <div class="col-sm-9">
    <div class="card">
      <div class="card-block">
        <h3 class="card-title">Web Application for retrieving detailed analysis report of student's performance:</h3>
      ...
      <div class="card-block">
        ...
        <p class="card-text">
            <form action='' method="post">
                ...
                <a href="register.html" class="btn btn-primary">Register</a> <br>
                  <?php
